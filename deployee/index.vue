...
<script>
import crudDepoloyee information from '@/api/depoloyee information'
...
export default {
  name: 'Depoloyee information',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: 'deployee_information', url: 'api/depoloyee information', idField: 'id', sort: 'id,desc', crudMethod: { ...crudDepoloyee information }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'depoloyee information:add'],
        edit: ['admin', 'depoloyee information:edit'],
        del: ['admin', 'depoloyee information:del']
      },
      rules: {
        id: [
